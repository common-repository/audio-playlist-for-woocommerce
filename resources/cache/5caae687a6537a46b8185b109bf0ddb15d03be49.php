<div id="sirvelia-player" style="background: <?php echo e($bg_color); ?>;" class="pb-fixed pb-w-full pb-left-0 pb-right-0 pb-bottom-0 pb-z-[9999] pb-text-white pb-pb-2">
    <audio class="player-audio" id="player-audio" src="<?php echo e($active_song ? $active_song->url : ''); ?>" preload="metadata"></audio>

    <div class="playlist-wrapper" style="background: <?php echo e($alt_color); ?>; display: none;">
        <div class="playlist-wrapper-container pb-block pb-relative pb-mx-auto pb-max-w-5xl">
            <a class="remove-all pb-text-white pb-absolute pb-top-[-40px] pb-right-0 pb-h-10 pb-px-4 pb-inline-block" style="background: <?php echo e($alt_color); ?>;" href="#"><?= __('Remove all', 'audio-playlist-for-woocommerce'); ?></a>

            <ul class="player-playlist pb-p-0 pb-list-none pb-m-0 pb-max-h-[150px] pb-overflow-y-auto">
                <?php if($playlist): ?>
                    <?php $__currentLoopData = $playlist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $song): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="pb-flex pb-justify-between pb-items-center playlist-item<?php echo e($song->isActive ? ' active' : ''); ?>">
                            <span class="song-info pb-flex pb-items-center pb-gap-2 pb-border-b pb- pb-border-0 pb-border-b-gray-200">
                                <a class="song pb-text-white hover:pb-gray-200 pb-no-underline" href="<?php echo e($song->url); ?>">
                                    <span class="song-title"><?php echo e($song->title); ?></span>
                                </a>
                                <a href="<?php echo e($song->productUrl); ?>" class="view-song pb-text-white"><?= __('Go to product', 'audio-playlist-for-woocommerce'); ?></a>
                            </span>
            ...
            <div class="info-data pb-flex pb-justify-between pb-items-center">
                <div class="pb-flex pb-gap-2 pb-items-center">
                    ...
                    <span class="current-time">
                        <?php if($time_cookie): ?>
                            <?php echo e($getPlaylistTime($time_cookie)); ?>

                        <?php endif; ?>
                    </span>
                </div>
                <?php if($active_song): ?>
                    <a class="view-album pb-text-white" href="<?php echo e($active_song->productUrl); ?>"><?= __('Go to product', 'audio-playlist-for-woocommerce'); ?></a>
                <?php endif; ?>
            </div>
...
</div><?php /**PATH /app/wp-content/plugins/audio-playlist-woo/resources/views/audio-player.blade.php ENDPATH**/ ?>